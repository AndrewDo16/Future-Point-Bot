    ...
    if not cursor.fetchone()[0]:
        cursor.execute("""
                       ...
                       (
                           ...
                           subscription_period_month INTEGER NOT NULL,
                           subscription_period_days  INTEGER NOT NULL
                       );

                       INSERT INTO telegram.price(price, currency, subscription_period_month, subscription_period_days)
                       VALUES (30, 'USDT', 1, 30);
                       INSERT INTO telegram.price(price, currency, subscription_period_month, subscription_period_days)
                       VALUES (90, 'USDT', 3, 90);
                       INSERT INTO telegram.price(price, currency, subscription_period_month, subscription_period_days)
...
# _________________________________________________________________________________________________________________
    ...
    if not cursor.fetchone()[0]:
        cursor.execute("""
                       ...
                       INSERT INTO telegram.crypto_wallet (wallet, chain, is_primary)
                       VALUES ('0x695bf46a362204B370e2914bbd5667068bE8f7d0', 'ВЕР20', TRUE);
